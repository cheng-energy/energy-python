...
ULR: [http://matplotlib.org/gallery.html](https://matplotlib.org/stable/gallery/)
...
- 如果想要选择ax2的子区域（plt.subplotgrid((3,3),(1,0),colspan=2)
1. 第一个参数表示把区域分割成3×3这样的9块区域
2. 第二个参数是指当前选定的位置是哪里，（1，0）是指在第一行第0列（行列都是从0开始）
3. colspan表示的是列的延申
4. rowspan是行的延申
